    ...
    >
      <div className="container mx-auto max-w-5xl lg:max-w-6xl xl:max-w-7xl 2xl:max-w-screen-2xl px-4 sm:px-6 lg:px-8 flex justify-between items-center">
        ...
        >
          <Link
            href="/"
            className="text-xl sm:text-2xl md:text-3xl font-bold text-sky-600 flex items-center"
          >
            Lahiru Liyanage
            <span className="text-yellow-500 dot font-bold">.</span>
          </Link>
        </motion.div>
            ...
            return (
              ...
              >
                ...
                >
                  {item.label}
                  <span
                    className={`absolute bottom-0 left-0 w-full h-0.5 bg-sky-600 transform transition-transform duration-300 ${
                      isActive
                        ? "scale-x-100"
