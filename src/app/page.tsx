                    ...
                    >
                        <div className="space-y-4">
                            ...
                            <div className="flex flex-wrap items-center gap-4 pt-4">
                                <Link
                                    href="/projects"
                                    className="bg-primary text-white px-6 py-2 rounded-full hover:bg-blue-700 transition flex items-center gap-2"
                                >
                                    View My Work
                                </Link>
                                <a
                                    href="/about"
                                    target="_blank"
                                    className="border border-primary text-primary px-6 py-2 rounded-full hover:bg-blue-50 transition flex items-center gap-2"
                                >
                                    <Download className="w-5 h-5" /> About Me
                                </a>
                            </div>
                    ...
                    >
                        <div className="relative">
                            <Image
                                ...
                                width={500}
                                height={500}
                                className="rounded-full shadow-2xl object-cover w-80 h-80 md:w-96 md:h-96"
                            />
